...
export const RSS_SOURCES = [
  ...
  // AI
  { name: 'OpenAI Blog',    url: 'https://openai.com/blog/rss/',                                 category: 'AI',   isChinese: false },
  { name: 'Anthropic Blog', url: 'https://www.anthropic.com/rss.xml',                            category: 'AI',   isChinese: false },
  ...
  { name: 'Byrdie',          url: 'https://www.byrdie.com/feeds/all-latest',                       category: '美妆', isChinese: false },
